 ...
 * @since 3.4.0
 */
define('VIEWS_PATH', join( DS, [ APP_PATH, 'views' ] ));
 ...
 * @since 3.4.0
 */
define('ASSETS_URL', join( DS, [ APP_URL, 'assets' ] ));
 ...
 * @since 3.6.0
 */
define('PARTIALS', join( DS, [ APP_PATH, 'views', 'partials' ] ));
 ...
 * @since 3.6.0
 */
define('TYPES', join( DS, [ APP_PATH, 'views', 'types' ] ));
 ...
 * @deprecated
 */
define('BASE', get_stylesheet_directory().DS);

/**
 * @deprecated
 */
define('URI', get_stylesheet_directory_uri().DS);
 ...
 * @deprecated
 */
define('ASSETS', GCS.'/jctda-assets');

/**
 * @deprecated
 */
define('MEDIA', GCS.'/jctda-media');
