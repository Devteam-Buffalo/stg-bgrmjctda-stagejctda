...
**  @desc    Page Builder contents for all types
**  @info    
**  @path    template-parts/page/page-builder.php
**  @package public
**  @author  Lee Peterson
**  @date    5/1/17
*/
						...
						if( ! empty($content_repeater) ) :
							...
							foreach( $content_repeater as $content ) :
								...
								if( $img ) :
									...
									$field_image = wp_get_attachment_image_url( $field_id, $med_args, false );
									...
									echo '<div class="uk-grid uk-grid-width-medium-1-2 uk-grid-width-1-1">';
										echo '<div class="">';
											if( $field_link ) echo '<a href="' . $field_link['url'] . '" title="' . $field_link['title'] . '" target="' . $field_link['target'] . '">';
												echo '<img src="' . $field_image . '" width="' . $med_args['width'] . '" alt="' . $img['alt'] . '">';
