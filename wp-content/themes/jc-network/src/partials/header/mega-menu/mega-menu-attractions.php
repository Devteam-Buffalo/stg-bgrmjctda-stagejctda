<?php
/*
**  @file    mega-menu-attractions.php
**  
**  @desc    
**  
**  @path    /mega-menu-attractions.php
**  @package public
**  @author  Lee Peterson
**  @date    8/1/17
*/
			...
			<div class="uk-grid uk-grid-small">
				<div class="uk-width-large-2-3 uk-width-1-1">
					<div class="mega-subnav-section-title-container">
						<h2 class="mega-subnav-section-title" style="font-family: 'Roboto Slab' !important;"><a href="<?php echo get_permalink( get_page_by_path( 'attractions' ) ); ?>" title="View Attractions" class="">Attractions <i class="uk-icon-angle-right"></i></a></h2>
					</div>
					...
					'menu'              => 'Attractions Mega',
					'theme_location'    => 'attractions-mega'
					) ); ?>
				</div>
				...
				<?php 
					...
					elseif( ! empty( $ad_image ) ) {
						...
						'<img src="' . $attractions_tile . '" class="mega-img-parent lazyload">';
					}
				?>
				</div>
			</div>
