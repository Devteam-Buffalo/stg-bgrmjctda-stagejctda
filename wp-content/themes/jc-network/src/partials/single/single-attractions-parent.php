...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
											...
											<a href="<?php the_permalink(); ?>" title="" class="uk-grid uk-grid-small location location-link outdoors-location">
												<div class="uk-width-1-4 location-image">
													...
													if($location_feat_url) : ?>
														<?php echo wp_get_attachment_image( $location_feat_url, array('100', '100'), false, array('class', 'image') ); ?>
													<?php else : ?>
														<img src="<?php echo get_template_directory_uri(); ?>/assets/img/attractions-sticky-icon.png" alt="<?php the_field('page_heading'); ?>" width="100" height="100" class="">
													<?php endif; ?>
												</div>
	...
	<footer class="uk-margin-large-bottom entry-footer">
	</footer><!-- .entry-footer -->
</article><!-- #post-## -->
