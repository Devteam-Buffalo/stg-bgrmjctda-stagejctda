...
$full_list = pods_field_display('full_stop_list'); ?>
...
<div id="route-<?php echo $route_id; ?>" class="uk-flex uk-flex-between" role="listitem">
	...
	<?php if( $out_map || $inb_map || $schedule || $full_list ) : ?>
	<div class="actions">
		...
		<div uk-drop mode="click" pos="bottom-right" offset="0">
			...
			<?php if( ! empty( $full_list ) ) : ?><a href="<?php echo $full_list; ?>" title="Download Full Stop List" id="full-stop-list" class="link" role="link">Full Stop List</a><?php endif; ?>
		</div>
	</div>
	<?php endif; ?>
</div>